...
namespace normal1_fit_model_namespace {
...
class normal1_fit_model final : public model_base_crtp<normal1_fit_model> {

 private:
  int N;
  std::vector<double> larceny_data; 
  
 
 public:
  ~normal1_fit_model() { }
  
  inline std::string model_name() const final { return "normal1_fit_model"; }
  ...
  normal1_fit_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "normal1_fit_model_namespace::normal1_fit_model";
    ...
    try {
      ...
      stan::math::validate_non_negative_index("larceny_data", "N", N);
      current_statement__ = 13;
      context__.validate_dims("data initialization","larceny_data","double",
      ...
      current_statement__ = 13;
      larceny_data = context__.vals_r("larceny_data");
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "normal1_fit_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
    ...
    try {
                ...
                0, lp__);
      {
        ...
        lp_accum__.add(stan::math::normal_lpdf<propto__>(mu, 2568, 878));
        current_statement__ = 9;
        lp_accum__.add(stan::math::exponential_lpdf<propto__>(sigma, 878));
        current_statement__ = 10;
        lp_accum__.add(
          stan::math::normal_lpdf<propto__>(larceny_data, mu, sigma));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "normal1_fit_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        stan::model::assign(log_lik,
          stan::math::normal_lpdf<false>(
            stan::model::rvalue(larceny_data, "larceny_data",
              stan::model::index_uni(i)), mu, sigma),
          "assigning variable log_lik", stan::model::index_uni(i));
      }
      double larceny_posterior = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 7;
      larceny_posterior = stan::math::normal_rng(mu, sigma, base_rng__);
      out__.write(log_lik);
      out__.write(larceny_posterior);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
    } // write_array_impl() 
  ...
  inline void constrained_param_names(
    ...
    if (emit_generated_quantities__) {
      ...
      param_names__.emplace_back(std::string() + "larceny_posterior");
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"},{\"name\":\"larceny_posterior\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
...
using stan_model = normal1_fit_model_namespace::normal1_fit_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return normal1_fit_model_namespace::profiles__;
}
